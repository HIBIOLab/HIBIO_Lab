...
def real_dataset_statistics():
    ...
    if not files:
        ...
        print("請先照第 14 課 prepare_ircadb_dataset.py 的說明下載、轉換好")
    ...
    print("   上卻完全沒用。這就是為什麼分割任務一定要看 Dice / IoU（第 14 課），")
...
# ------------------------------------------------------------------
# 課後練習：這一課沒有獨立的課後練習，跟第 14 課合併在一起做
# （對照 index.html 第 14 課「Dice Coefficient 與 IoU」的課後練習）。
# ------------------------------------------------------------------
